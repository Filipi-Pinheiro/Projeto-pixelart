...
let changeColor = () => {
  ...
  const check = (bnt) => bnt.getAttribute("data-color") != currentColor
...
colResize.addEventListener("mousedown", () => (isResize = true));
main.addEventListener("mouseup", () => (isResize = false));
